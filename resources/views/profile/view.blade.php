        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div class="bg-white p-3 shadow rounded-lg md:col-span-2">
                <form x-data="{
                    ...
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Detalji Korisnika</h2>
                    ...
                    <h2 class="text-xl mt-6 font-semibold mb-2">Naplatna Adresa</h2>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                            <x-input
                                type="text"
                        ...
                        <div>
                            <template x-if="billingCountryStates">
                                <x-input type="select"
                                         ...
                                         class="w-full focus:border-purple-600 focus:ring-purple-600 border-gray-300 rounded">
                                    <option value="">Izaberi Županiju</option>
                    ...
                    <div class="flex justify-between mt-6 mb-2">
                        <h2 class="text-xl font-semibold">Adresa Dostave</h2>
                        <label for="sameAsBillingAddress" class="text-gray-700">
                            <input @change="$event.target.checked ? shippingAddress = {...billingAddress} : ''"
                                   ...
                                   class="text-purple-600 focus:ring-purple-600 mr-2"> Ista kao naplatna
                        </label>
                    </div>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                    ...
                    <x-button class="w-full">Ažuriraj</x-button>
                </form>
            </div>
            <div class="bg-white p-3 shadow rounded-lg">
                <form action="{{route('profile_password.update')}}" method="post">
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Ažuriraj Lozinku</h2>
                    <div class="mb-3">
                        <x-input
                            type="password"
                            name="old_password"
                    ...
                    <div class="mb-3">
                        <x-input
                            ...
                            placeholder="Ponovi novu lozinka"
                            class="w-full focus:border-purple-600 focus:ring-purple-600 border-gray-300 rounded"
                        />
                    </div>
                    <x-button>Ažuriraj</x-button>
                </form>
            </div>
        </div>
    </div>
