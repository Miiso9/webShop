<template>
    <header class="display flex justify-between items-center p-3 h-14 shadow bg-white">
...
<script setup>
import {ArrowLeftOnRectangleIcon, UsersIcon} from '@heroicons/vue/24/outline'
