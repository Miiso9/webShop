<template>
    <div class="mb-2 flex items-center justify-between">
        <h1 class="text-3xl font-semibold">Nadzorna Ploča</h1>
        <div class="flex items-center">
            <label class="mr-2">Promjeni Vremenski Period</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
        ...
        <div class="animate-fade-in-down bg-white py-6 px-5 rounded-lg shadow flex flex-col items-center justify-center">
            <label class="text-lg font-semibold block mb-2">Aktivni Kupci</label>
        ...
        <div class="animate-fade-in-down bg-white py-6 px-5 rounded-lg shadow flex flex-col items-center justify-center"
            ...
            <label class="text-lg font-semibold block mb-2">Aktivni Proizvodi</label>
        ...
        <div class="animate-fade-in-down bg-white py-6 px-5 rounded-lg shadow flex flex-col items-center justify-center"
            ...
            <label class="text-lg font-semibold block mb-2">Plaćene Narudžbe</label>
        ...
        <div class="animate-fade-in-down bg-white py-6 px-5 rounded-lg shadow flex flex-col items-center"
            ...
            <label class="text-lg font-semibold block mb-2">Ukupni Prihod</label>
    ...
    <div class="grid grid-rows-1 md:grid-rows-2 md:grid-flow-col grid-cols-1 md:grid-cols-3 gap-3">
        <div class="col-span-1 md:col-span-2 row-span-1 md:row-span-2 bg-white py-6 px-5 rounded-lg shadow">
            <label class="text-lg font-semibold block mb-2">Zadnje Narudžbe</label>
        ...
        <div class="bg-white py-6 px-5 rounded-lg shadow flex flex-col items-center justify-center">
            <label class="text-lg font-semibold block mb-2">Narudžbe po Državama</label>
        ...
        <div class="bg-white py-6 px-5 rounded-lg shadow">
            <label class="text-lg font-semibold block mb-2">Zadnji Kupci</label>
...
function updateDashboard() {
    ...
    axiosClient.get(`/dashboard/orders-by-country`, { params: { d } }).then(({ data: countries }) => {
        ...
        countries.forEach(c => {
            ...
            chartData.datasets.data.push(c.count);
        });
